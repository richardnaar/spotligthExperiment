...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\pcadmin\\Documents\\dok\\TARU\\PROJEKTID\\EEGManyLabs\\Task\\spotlight_replication\\Müller_et_al_2003_v2024_2_4beta.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisBlock in blocks:
        ...
        for thisCondition in conditions:
            ...
            if eog_calib and conditions.thisN % 3 == 0:
            ...
            while continueRoutine:
                ...
                # --- Key handling ---
                calibration_positions[current_calib_index][0]
                keys = event.getKeys()
                ...
                if eog_calib and not calibration_done:
                    ...
                    if phase == "hold":
                        ...
                        calib_dot.lineWidth = 5.0 + 5.0 * np.sin(np.pi * p)  # one sycle
                        ...
                        if 'target' in imageArray[randImage[cond[0]]] and 'target' in imageArray[randImage[cond[1]]]:
                            ...
                            if frameN-frameCount >= waitNextPairFrames+symShowFrames:
                                ...
                                if targetPair and not responseGiven:
                                    addData('miss', targetPair, absNumOfTrials, nrOfEntries, 0) # Add data
                    ...
                    if keys:
                        if 'space' in keys[-1].name:
                            ...
                            if not isTraining:
                                sendTrigger(t-t2, trigN, expInfo['EEG'], 0.05)
                            if not targetPair:
                                addData('false alarm', targetPair, absNumOfTrials, nrOfEntries, 0)
