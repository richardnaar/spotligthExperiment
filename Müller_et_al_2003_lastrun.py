...
ecc = [4, 9] # Maybe the distance was still from the middle of the symbol
...
text_block = visual.TextStim(win=win, name='text_block',
    text='',
    font='Open Sans',
    units='deg', pos=(0, 0), height=2.0, wrapWidth=20.0, ori=0.0, 
...
for thisBlock in blocks:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    text_block.setText(attendCond + '\n\nWhich hand: ' + hands[blocks.thisRepN])
